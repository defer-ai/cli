...
export async function askCommand(topic: string): Promise<void> {
  ...
  console.log();
  console.log(
    `Next time your AI reads the project, it will see this and generate`
  );
  console.log(
    `decision questions specifically about ${chalk.cyan(topic)}.`
  );
  console.log();
