...
import { createStore, loadStore, saveStore, storeExists, nextDecisionId, } from "./decisions.js";
...
describe("Decision Store", () => {
    ...
    describe("saveStore", () => {
        it("generates DECISIONS.md with correct format", () => {
            ...
            store.decisions.push(makeDecision({ id: "STACK-001", category: "Stack", question: "Language?", answer: "TypeScript" }), makeDecision({ id: "DATA-001", category: "Data", question: "Database?", answer: null }), makeDecision({ id: "UI-001", category: "UI", question: "Framework?", answer: "React", delegated: true }));
            saveStore(tmpDir, store);
