...
export function App({ task, provider }) {
    ...
    return (_jsxs(Box, { flexDirection: "row", height: rows, children: [_jsx(Box, { flexDirection: "column", width: 6, paddingTop: 1, children: tabs.map((tab) => {
                ...
                }) }), _jsx(Box, { flexDirection: "column", flexGrow: 1, children: _jsx(Box, { flexDirection: "column", flexGrow: 1, children: view === "decisions" && current ? (_jsx(DecisionModal, { agent: current, onAnswer: handleDecisionAnswer, onAsk: handleDecisionAsk, onRevise: handleDecisionRevise, onDone: () => setView("stream"), rows: rows - 2 })) : (_jsxs(_Fragment, { children: [_jsxs(Box, { flexGrow: 1, children: [_jsx(Box, { flexDirection: "column", paddingX: 1, paddingTop: 1, children: _jsx(Mascot, { mood: mood }) }), _jsxs(Box, { flexDirection: "column", flexGrow: 1, paddingX: 1, children: [_jsxs(Box, { paddingTop: 1, marginBottom: 1, children: [_jsx(Text, { color: "cyan", bold: true, children: "defer" }), _jsxs(Text, { color: "gray", dimColor: true, children: [" v0.1.0 | ", model] })] }), view === "banner" && !current ? (_jsxs(Box, { flexDirection: "column", children: [_jsxs(Text, { color: "gray", dimColor: true, children: ["cwd ", process.cwd().replace(process.env.HOME || "", "~")] }), _jsx(Box, { marginTop: 1, children: _jsx(Text, { color: "gray", dimColor: true, children: "/help for commands, tab to switch views" }) })] })) : view === "git" ? (_jsx(GitView, {})) : (_jsxs(Box, { flexDirection: "column", flexGrow: 1, children: [current?.status === "thinking" &&
